    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobNeeds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobNeeds_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobNeeds_Needs_NeedId",
                        column: x => x.NeedId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PacketName1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PacketDescription1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryTime1 = table.Column<int>(type: "int", nullable: false),
                    Price1 = table.Column<double>(type: "float", nullable: false),
                    Revision1 = table.Column<int>(type: "int", nullable: false),
                    PacketName2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PacketDescription2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryTime2 = table.Column<int>(type: "int", nullable: false),
                    Price2 = table.Column<double>(type: "float", nullable: false),
                    Revision2 = table.Column<int>(type: "int", nullable: false),
                    PacketName3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PacketDescription3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryTime3 = table.Column<int>(type: "int", nullable: false),
                    Price3 = table.Column<double>(type: "float", nullable: false),
                    Revision3 = table.Column<int>(type: "int", nullable: false),
                    JobId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobNeeds_JobId",
                table: "JobNeeds",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_JobNeeds_NeedId",
                table: "JobNeeds",
                column: "NeedId");
